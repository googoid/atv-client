...
function authenticate() {
  ...
  return connect(ipAddress, port)
    ...
    .then(() => postDataSocket(socket, '/play', 'application/x-apple-binary-plist', plist.bplistCreator({
        'Content-Location': 'http://data04-cdn.datalock.ru/fi2lm/053b096c10388c7357164adc532efffc/7f_A.Place.To.Call.Home.S05E01.720p.HDTV.ColdFilm.Ru.a0.22.11.17.mp4',
        'Start-Position': 0.5
      }), true))
    .then(() => {
